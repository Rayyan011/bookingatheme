...
<main>
    ...
    <section class="why-ovayo-section bg-ovayo-30">
        <div class="container">
            <div class="about-grid">
                <!-- Content -->
                <div class="about-content bg-ovayo-10">
                    <h2>Why Ovayo</h2>
    ...
    <!-- =======================
    Core Values START -->
    <section class="core-values-section bg-ovayo-10">
        <div class="container">
            <h2 class="core-values-title">Core values</h2>
            <div class="values-grid">
                <!-- Value Item 1 -->
                <div class="value-item bg-ovayo-30">
    ...
    <section class="team-section">
        <div class="container">
            <h2 class="section-title">Meet the Wish Keepers</h2>
